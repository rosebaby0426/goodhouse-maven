package com.christine.goodhouse;
 ...
 * */
@SpringBootApplication(scanBasePackages = "com.christine.goodhouse.*")
public class GoodHouseApplication {

    @Value("${server.tomcat.protocol:org.apache.coyote.http11.Http11Nio2Protocol}")
    private String tomcatProtocol;

    public static void main(String[] args) {
        SpringApplication.run(GoodHouseApplication.class, args);
    }
